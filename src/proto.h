...
idx_t CheckRInfoExtended(ctrl_t *ctrl, graph_t *graph, idx_t vtx);
idx_t CheckRInfoExtendedFull(ctrl_t *ctrl, graph_t *graph);
void PrintRInfoVol(ctrl_t *ctrl, graph_t *graph, idx_t vtx);
